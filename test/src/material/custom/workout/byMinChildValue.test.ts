...
describe('by minimum child value', () => {
    it('errors for even minimum child values', () => {
        expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(2) }))
            .toThrowError(`Cannot compute workout-shaped child stairs with an even minimum child value. This minimum child value was 2.`)
        expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(8) }))
...
and the multiple is 4x whichth odd number it is)`,
        () => {
            it('works for parent values of 1 + 4n', () => {
            ...
            it('works for parent values of 3 + 4n', () => {
    ...
    describe('minimum child value of 3', () => {
        it('works for parent values of 3 + 8n', () => {
        ...
        it('works for parent values of 5 + 8n', () => {
        ...
        it('errors for other odd parent values', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(1), { minChildValue: musicalAs.Value(3) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 1 and minimum child value 3.')

            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(7), { minChildValue: musicalAs.Value(3) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 7 and minimum child value 3.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(3) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 9 and minimum child value 3.')

            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(15), { minChildValue: musicalAs.Value(3) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 15 and minimum child value 3.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(17), { minChildValue: musicalAs.Value(3) }))
    ...
    describe('minimum child value of 5', () => {
        it('works for parent values of 5 + 12n', () => {
        ...
        it('works for parent values of 7 + 12n', () => {
        ...
        it('errors for other odd parent values', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(1), { minChildValue: musicalAs.Value(5) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 1 and minimum child value 5.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(3), { minChildValue: musicalAs.Value(5) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 3 and minimum child value 5.')

            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(5) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 9 and minimum child value 5.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(11), { minChildValue: musicalAs.Value(5) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 11 and minimum child value 5.')
        })
    })

    describe('minimum child value of 7', () => {
        it('works for parent values of 7 + 16n', () => {
        ...
        it('works for parent values of 9 + 16n', () => {
        ...
        it('errors for other odd parent values', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(11), { minChildValue: musicalAs.Value(7) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 11 and minimum child value 7.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(13), { minChildValue: musicalAs.Value(7) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 13 and minimum child value 7.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(15), { minChildValue: musicalAs.Value(7) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 15 and minimum child value 7.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(17), { minChildValue: musicalAs.Value(7) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 17 and minimum child value 7.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(19), { minChildValue: musicalAs.Value(7) }))
                .toThrowError('Cannot compute workout-shaped child stairs for parent value 19 and minimum child value 7.')
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(21), { minChildValue: musicalAs.Value(7) }))
