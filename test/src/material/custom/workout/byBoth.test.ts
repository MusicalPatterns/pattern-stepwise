...
describe('by both minimum child value and child count', () => {
    it('errors for even minimum child values', () => {
        expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(9), {
    ...
    describe('minimum child value of 3 and child count of 1', () => {
        it('works for parent values of 3 or 5', () => {
        ...
        it('errors for other odd parent values, but because child count of 1 works for any odd parent value, you cannot get a new error here, only the ones you would get trying a bad minimum child value and parent value combination', () => {
            // tslint:disable-next-line no-empty-block
        })
    })

    describe('minimum child value of 3 and child count of 3', () => {
        it('works for parent values of 11 or 13', () => {
        ...
        it('errors for other values that could have worked for that parent value and minimum child value combination or that parent value and child count combination but cannot work all together', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(5), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(3),
            }))
        ...
        it('can still give you the error specific to parent value and child count', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(3), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(3),
            }))
        ...
        it('can still give you the error specific to parent value and minimum child value', () => {
        ...
        it('can give you an error if it cannot work for either that parent value and child count combination or that parent value and minimum child value combination', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(1), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(3),
            }))
    ...
    describe('minimum child value of 3 and child count of 5', () => {
        it('works for parent values of 19 or 21', () => {
    ...
    describe('minimum child value of 5 and child count of 1', () => {
        it('works for parent values of 5 or 7', () => {
            expect(computeWorkoutShapedChildStairs(musicalAs.Value(5), {
                childCount: as.Cardinal<Block>(1),
        ...
        it('errors for other odd parent values, but because child count of 1 works for any odd parent value, you cannot get a new error here, only the ones you would get trying a bad minChildValue and parentValue combination', () => {
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(3), {
                childCount: as.Cardinal<Block>(1),
                minChildValue: musicalAs.Value(5),
            }))
    ...
    describe('minimum child value of 5 and child count of 3', () => {
        it('works for parent values of 17 or 19', () => {
            expect(computeWorkoutShapedChildStairs(musicalAs.Value(17), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(5),
            }))
        ...
        it('actually cannot give the error specific to parent value and child count because for that to happen it would have to work for parent value and minimum child value but not for parent value and child count, and the only ones that would work for parent value and minimum child value would also work for parent value and child count', () => {
            // tslint:disable-next-line no-empty-block
        })
        ...
        it('can still give you the error specific to parent value and minimum child value', () => {
            ...
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(25), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(5),
            }))
    ...
    describe('min child value of 5 and child count of 5', () => {
        it('works for parent values of 29 or 31', () => {
            expect(computeWorkoutShapedChildStairs(musicalAs.Value(29), {
                childCount: as.Cardinal<Block>(5),
                minChildValue: musicalAs.Value(5),
            }))
        ...
        it('errors for other values that could have worked for that parent value and minimum child value combination or that parent value and child count combination but cannot work all together', () => {
            ...
            expect(() => computeWorkoutShapedChildStairs(musicalAs.Value(41), {
                childCount: as.Cardinal<Block>(5),
                minChildValue: musicalAs.Value(5),
            }))
