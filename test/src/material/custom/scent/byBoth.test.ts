...
describe('by both child count and minimum child value', () => {
    it('errors for even minimum child values', () => {
        expect(() => computeDescentShapedChildStairs(musicalAs.Value(9), {
    ...
    describe('minimum child value of 3 and child count of 1', () => {
        it('works for parent value of 3 only', () => {
        ...
        it('errors for other odd parent values', () => {
            expect(() => computeDescentShapedChildStairs(musicalAs.Value(1), {
                childCount: as.Cardinal<Block>(1),
                minChildValue: musicalAs.Value(3),
            }))
    ...
    describe('minimum child value of 3 and child count of 3', () => {
        it('works for parent value of 15 only', () => {
    ...
    describe('minimum child value of 3 and child count 5', () => {
        it('works for parent value of 35 only', () => {
        ...
        it('errors for other odd parent values', () => {
            expect(() => computeDescentShapedChildStairs(musicalAs.Value(25), {
                childCount: as.Cardinal<Block>(5),
                minChildValue: musicalAs.Value(3),
            }))
    ...
    describe('minimum child value of 5 and child count of 1', () => {
        it('works for parent value of 5 only', () => {
            expect(computeDescentShapedChildStairs(musicalAs.Value(5), {
                childCount: as.Cardinal<Block>(1),
        ...
        it('errors for other odd parent values', () => {
            ...
            expect(() => computeDescentShapedChildStairs(musicalAs.Value(7), {
                childCount: as.Cardinal<Block>(1),
                minChildValue: musicalAs.Value(5),
            }))
    ...
    describe('minimum child value of 5 and child count of 3', () => {
        it('works for parent value of 21 only', () => {
            expect(computeDescentShapedChildStairs(musicalAs.Value(21), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(5),
            }))
        ...
        it('errors for other odd parent values', () => {
            ...
            expect(() => computeDescentShapedChildStairs(musicalAs.Value(27), {
                childCount: as.Cardinal<Block>(3),
                minChildValue: musicalAs.Value(5),
            }))
    ...
    describe('minimum child value of 5 and child count of 5', () => {
        it('works for parent value of 45 only', () => {
            expect(computeDescentShapedChildStairs(musicalAs.Value(45), {
                childCount: as.Cardinal<Block>(5),
                minChildValue: musicalAs.Value(5),
            }))
        ...
        it('errors for other odd parent values', () => {
            ...
            expect(() => computeDescentShapedChildStairs(musicalAs.Value(55), {
                childCount: as.Cardinal<Block>(5),
                minChildValue: musicalAs.Value(5),
            }))
