...
describe('by minimum child value', (): void => {
    it('errors for even minimum child values', (): void => {
        expect((): void => {
            computeDescentShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(2) })
        })
            .toThrowError(`Cannot compute scent-shaped child stairs with an even minimum child value. This minimum child value was 2.`)
        expect((): void => {
            computeDescentShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(8) })
        })
            .toThrowError(`Cannot compute scent-shaped child stairs with an even minimum child value. This minimum child value was 8.`)

        expect((): void => {
            computeAscentShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(2) })
        })
            .toThrowError(`Cannot compute scent-shaped child stairs with an even minimum child value. This minimum child value was 2.`)
        expect((): void => {
            computeAscentShapedChildStairs(musicalAs.Value(9), { minChildValue: musicalAs.Value(8) })
        })
            .toThrowError(`Cannot compute scent-shaped child stairs with an even minimum child value. This minimum child value was 8.`)
    })

    describe('minimum child value of 1', (): void => {
        it('works for parent values of n^2, where n is odd', (): void => {
    ...
    describe('minimum child value of 3', (): void => {
        it('works for parent values of n^2 + 2*n, where n is odd', (): void => {
    ...
    describe('minimum child value of 5', (): void => {
        it('works for parent values of n^2 + 4*n, where n is odd', (): void => {
